...
{
    public class PhotosPrintHelper : PrintHelper
    {
        ...
        public WriteableBitmap RBitmap { get; set; }
        ...
        protected override void PrintTaskRequested(Windows.Graphics.Printing.PrintManager sender, Windows.Graphics.Printing.PrintTaskRequestedEventArgs e)
        {
            ...
            printTask = e.Request.CreatePrintTask("Print Your Ink", sourceRequestedArgs =>
            {
        ...
        protected override async void GetPrintPreviewPage(object sender, GetPreviewPageEventArgs e)
        {
            ...
            if (!pageReady)
            {
                ...
                page = await GeneratePageAsync(pageNumber, currentPageDescription, RBitmap);
        ...
        protected override async void AddPrintPages(object sender, AddPagesEventArgs e)
        {
            ...
            for (int i = 0; i < NumberOfPhotos; i++)
            {
                ...
                if (!pageReady)
                {
                    ...
                    page = await GeneratePageAsync(i + 1, currentPageDescription, RBitmap);
                }
        ...
        private async Task<UIElement> GeneratePageAsync(int photoNumber, PageDescription pageDescription, WriteableBitmap bitmap)
        {
