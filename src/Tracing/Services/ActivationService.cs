    ...
    internal class ActivationService
    {
        ...
        private async Task StartupAsync()
        {
            await FirstRunDisplayService.ShowIfAppropriateAsync(() =>
            {
                ...
                {
                    App.AppSettings.DefaultCanvasHeight = (int)size.Height;
                    App.AppSettings.DefaultCanvasWidth = (int)size.Width;
                }

                NavigationService.Navigate(typeof(WelcomeFlipViewModel).FullName);
            });
        ...
        {
            yield return Singleton<FileLaunchActivationHandler>.Instance;
        }
